...
var map = {
	"./accountmanagement/accountmanagement.module": [
		622,
		0
	],
	...
	"./dynamicreports/dynamicreports.module": [
		624,
		3
	],
	"./users/users.module": [
...
var routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'accountmanagement', loadChildren: './accountmanagement/accountmanagement.module#AccountmanagementModule' },
            { path: 'dynamicreports', loadChildren: './dynamicreports/dynamicreports.module#DynamicreportsModule' },
